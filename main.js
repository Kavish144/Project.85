...
function ADOWN() {
    if(car2_y <=500) 
    { car2_y =car2_y+ 10; console.log("When A is pressed, x = " + car2_x + " | y = " + car2_y);
     uploadBackground();
     uploadcar2(); 
    uploadcar1();
    }
 ...
 function SLEFT() {
    if(car2_x >= 0)
     { car2_x =car2_x - 10; console.log("When S is pressed, x = " + car2_x + " | y = " + car2_y);
     uploadBackground();
     uploadcar2(); 
    uploadcar1();
    }
 ...
 if (car1_x>700) {
     ...
     document.getElementById("winner").innerHTML = "Car 1 Won!!"
 }
 
 if (car2_x>700) {
     console.log("car2 won")
    document.getElementById("winner").innerHTML = "Car 2 Won!!"
}